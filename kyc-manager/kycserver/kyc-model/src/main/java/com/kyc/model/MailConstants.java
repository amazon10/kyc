...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "kyc.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "kyc.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "kyc.mail.routing.key";
}
